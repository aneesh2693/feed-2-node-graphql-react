  ...
  finishEditHandler = postData => {
    ...
    fetch('http://localhost:8080/post-image', {
      ...
      .then(fileResData => {
        ...
        let graphqlQuery = {
                query: `
                  mutation createFeed($newTitle: String!, $newContent: String!, $newFilePath: String!) {
                ...
                variables: {
                  ...
                  newFilePath: fileResData.filePath || 'undefined'
                }
              };
        if (this.state.editPost) {
          graphqlQuery = {
                query: `
                  mutation updateFeed($postId: ID!, $updatedTitle: String!, $updatedContent: String!, $updatedFilePath: String!) {
                    updatePost(
                      id: $postId
                      postInput: {
                        title: $updatedTitle,
                ...
                `,
                  variables: {
                    ...
                    updatedFilePath: fileResData.filePath || 'undefined'
                  }
              };
        }
